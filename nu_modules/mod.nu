...
use resource-path.nu [list-contained-resource-files open-state-record open-state-record-or-default path-type-safe resolve-under-base save-state-replace validate-resource-name]
