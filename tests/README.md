...
| `test_request_body.nu` | Dependency-resolved trusted maps shared across URL/headers/structured JSON/forms, null preservation, body-file injection safety, table replay/chains, opaque extracted values through run/exec, literal header names, preview/export fidelity, and credential masking |
