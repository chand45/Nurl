...
# Download nu_modules
MODULES=("mod.nu" "http.nu" "auth.nu" "vars.nu" "history.nu" "chain.nu" "tui.nu" "log.nu" "resource-path.nu" "state-store.nu" "command-error.nu" "curl-capability.nu" "string-compat.nu")
