...
# Usage: curl -sSL https://raw.githubusercontent.com/cgaddam_microsoft/Nurl/cg/add_installation_scripts/install.sh | bash
...
# Configuration
NURL_HOME="$HOME/.nurl"
REPO_URL="https://raw.githubusercontent.com/cgaddam_microsoft/Nurl/cg/add_installation_scripts"
